...
from envs.mujoco.utils.mujoco_utils import get_qpos_indices, get_qvel_indices
...
class PushingEnv(kuka_env.KukaEnv):
	...
	def __init__(self,
		...
		if random_init_pos_file is None:
			self.init_qpos_kuka = [
				np.array([-0.39644391, 0.90374878, 0.29834325, -1.32769707, 0.32136548, 1.0627125, -0.37159982])
