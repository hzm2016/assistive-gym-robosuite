...
class PegInsertionEnv(kuka_env.KukaEnv):
    ...
    def __init__(self,
        ...
        #     self.random_hole_file = random_hole_file
        #     self.reachable_holes = np.load(os.path.join(kuka_asset_dir(), self.random_hole_file), allow_pickle=True)
        #     self._reset_target()
    ...
    def _get_reward(self, state, action):
        ...
        return reward*self.sac_reward_scale, reward_info
    ...
    def get_context(self):
        ...
        if self.contextual_policy:
            ...
            # return np.concatenate((pos[1], hole_quat))
            return hole_quat
