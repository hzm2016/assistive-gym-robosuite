...
from envs.robosuite.robosuite.utils.macros import *
from envs.robosuite.robosuite.utils import XMLError
from envs.robosuite.robosuite.utils.mjcf_utils import find_elements, sort_elements,\
...
class MujocoXMLModel(MujocoXML, MujocoModel):
    ...
    def __init__(self, fname, idn=0):
        ...
        if USING_INSTANCE_RANDOMIZATION:
