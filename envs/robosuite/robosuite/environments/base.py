...
from envs.robosuite.robosuite.utils import SimulationError, XMLError, MujocoPyRenderer
from envs.robosuite.robosuite.utils import macros
from envs.robosuite.robosuite.models.base import MujocoModel
...
def make(env_name, *args, **kwargs):
    """
    Instantiates a envs.robosuite.robosuite environment.

    This method attempts to mirror the equivalent functionality of gym.make in a somewhat sloppy way.

    Args:
        env_name (str): Name of the envs.robosuite.robosuite environment to initialize
    ...
    Returns:
        MujocoEnv: Desired envs.robosuite.robosuite environment
...
class MujocoEnv(metaclass=EnvMeta):
    ...
    Args:
        ...
        hard_reset (bool): If True, re-loads model, sim, and render object upon a reset call, else,
            only calls sim.reset and resets all envs.robosuite.robosuite-internal variables
    ...
    def reset(self):
        ...
        # Reset necessary envs.robosuite.robosuite-centric variables
        self._reset_internal()
        self.sim.forward()
    ...
    def _reset_internal(self):
        ...
        if self.has_renderer and self.viewer is None:
            ...
            # (see https://github.com/StanfordVL/envs.robosuite.robosuite/issues/39)
