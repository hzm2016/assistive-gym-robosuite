...
python experiment_organizer.py obstacle_2d_test_def_more_1 --task_name reacher2d_obstacle -n 1 --n_evaluations 300 --imitation_learning 16500 --batch_size 300 -z --max_iter 10 -c 10. --il_noise 0.001  --dense  --kl_bound 0.1 --forward
#--start_id 1
