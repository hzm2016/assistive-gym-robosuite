...
class ScratchItchEnv(AssistiveEnv):
    ...
    def _get_obs(self, agent=None):
        ...
        if self.human.controllable:
            ...
            tool_pos_human, tool_orient_human = self.human.convert_to_realworld(self.tool_pos, tool_orient)
    ...
    def generate_target(self):
        ...
        self.tool_pos, tool_orient = self.tool.get_pos_orient(1)
        self.target_tool = self.create_sphere(radius=0.01, mass=0.0, pos=self.tool_pos, visual=True, collision=False,
                                         rgba=[0, 1, 1, 1])
