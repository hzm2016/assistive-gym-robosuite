...
class VariableImpedanceController(BaseController):
    '''
    ...
    def __init__(self,
                 ...
                 in_ee_frame=False):
        super(VariableImpedanceController, self).__init__(sim)
...
register_controller(VariableImpedanceController, "VariableImpedanceController")