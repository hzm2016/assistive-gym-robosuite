...
parser.add_argument("--render", default=True, help="Whether to render this test or not for visual validation")
...
def test_all_controllers():
    for controller_name in controllers.keys():
        ...
        while count < num_test_steps:
            action = neutral.copy()
            print("nature action :::", action)
            # action = np.array([0.0, 0.0, 0.01, 0.0, 0.0, 0.0, 0.0])
