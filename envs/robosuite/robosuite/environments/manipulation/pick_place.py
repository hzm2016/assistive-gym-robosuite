...
from envs.robosuite.robosuite.models.arenas import BinsArena
from envs.robosuite.robosuite.models.objects import (
    MilkObject,
    BreadObject,
    CerealObject,
    CanObject,
...
from envs.robosuite.robosuite.utils.placement_samplers import SequentialCompositeSampler, UniformRandomSampler
...
class PickPlace(SingleArmEnv):
    ...
    def _load_model(self):
        ...
        print("save model :::")
        self.model.save_model("pick_and_place.xml")
