...
from envs.mujoco.utils.kinematics import forwardKin, inverseKin, identity_quat
...
def hole_insertion_samples_unrestricted(sim, nsamples=10, insertion_range=(0, 0.05), raise_on_fail=False):
	...
	for w_pos, w_quat in zip(world_pos_desired, world_quat_desired):
		q_opt = inverseKin(sim, q_init, q_nom, tip_body_pos, w_pos, w_quat, peg_body_id, upper=upper, lower=lower,
