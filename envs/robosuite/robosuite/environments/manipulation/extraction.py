...
from envs.robosuite.robosuite.utils.transform_utils import convert_quat
from envs.robosuite.robosuite.utils.mjcf_utils import CustomMaterial

from envs.robosuite.robosuite.environments.manipulation.single_arm_env import SingleArmEnv

from envs.robosuite.robosuite.models.arenas import TableArena
from envs.robosuite.robosuite.models.objects import BoxObject
from envs.robosuite.robosuite.models.tasks import ManipulationTask
from envs.robosuite.robosuite.utils.placement_samplers import UniformRandomSampler
from envs.robosuite.robosuite.utils.observables import Observable, sensor


class Extract(SingleArmEnv):
    """
        ...
        if not self.deterministic_reset:
            ...
            for obj_pos, obj_quat, obj in object_placements.values():
                ...
                self.sim.data.set_joint_qpos(obj.joints[0],
                                             np.concatenate([np.array([0., i, 0.93]), np.array([1, 0, 0, 1])]))
                i += 0.1
